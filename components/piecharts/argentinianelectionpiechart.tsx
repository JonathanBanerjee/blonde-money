...
export const description = "Argentinian Presidential Electiont";

const electionData = [
  { party: "pl", seats: 55.65, fill: "var(--color-pl)" },
  { party: "fr", seats: 44.35, fill: "var(--color-fr)" },
];
...
export function ArgentinianElectionPieChart() {
